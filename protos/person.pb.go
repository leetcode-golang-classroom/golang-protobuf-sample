...
var file_protos_person_proto_rawDesc = []byte{
	...
	0x4b, 0x10, 0x02, 0x42, 0x44, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x6c, 0x65, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x2d, 0x67, 0x6f, 0x6c, 0x61, 0x6e,
	0x67, 0x2d, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x72, 0x6f, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x6c, 0x61,
	0x6e, 0x67, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2d, 0x73, 0x61, 0x6d, 0x70,
...
var file_protos_person_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_protos_person_proto_goTypes = []any{
...
func file_protos_person_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_person_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_protos_person_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Person); i {
			case 0:
				return &v.state
			case 1:
